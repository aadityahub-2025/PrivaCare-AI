...
║         Model: Logistic Regression  |  Mechanism: Laplace (pure ε-DP)      ║
║                                                                              ║
║  DP Correctness:                                                             ║
...
def load_and_train(epsilon=0.5):
    ...
    # DP model -- Laplace noise on features
    ...
    return {
        ...
        "laplace_b": b, "model_type": "LR-Laplace",
    }
